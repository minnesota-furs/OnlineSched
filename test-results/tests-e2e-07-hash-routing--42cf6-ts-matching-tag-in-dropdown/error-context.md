...
- Name: tests/e2e/07-hash-routing.spec.js >> 07 — Hash Routing >> #tag- hash selects matching tag in dropdown
- Location: tests/e2e/07-hash-routing.spec.js:14:3
...
Call log:
  - navigating to "/schedule/#tag-Fursuiting", waiting until "load"
