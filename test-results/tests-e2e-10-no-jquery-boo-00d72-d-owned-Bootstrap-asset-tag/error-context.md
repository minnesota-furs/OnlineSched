...
- Name: tests/e2e/10-no-jquery-bootstrap.spec.js >> 10 — No jQuery / Bootstrap (Phase 6+) >> no OnlineSched-owned Bootstrap asset tag
- Location: tests/e2e/10-no-jquery-bootstrap.spec.js:37:3
