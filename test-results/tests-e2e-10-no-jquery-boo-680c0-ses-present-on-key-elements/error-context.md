...
- Name: tests/e2e/10-no-jquery-bootstrap.spec.js >> 10 — No jQuery / Bootstrap (Phase 6+) >> os- namespaced classes present on key elements
- Location: tests/e2e/10-no-jquery-bootstrap.spec.js:127:3
