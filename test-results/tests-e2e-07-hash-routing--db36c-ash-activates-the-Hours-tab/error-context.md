...
- Name: tests/e2e/07-hash-routing.spec.js >> 07 — Hash Routing >> #hour hash activates the Hours tab
- Location: tests/e2e/07-hash-routing.spec.js:6:3
...
Call log:
  - navigating to "/schedule/#hour", waiting until "load"
