...
- Name: tests/e2e/10-no-jquery-bootstrap.spec.js >> 10 — No jQuery / Bootstrap (Phase 6+) >> no Bootstrap requires jQuery console error
- Location: tests/e2e/10-no-jquery-bootstrap.spec.js:14:3
