...
- Name: tests/e2e/10-no-jquery-bootstrap.spec.js >> 10 — No jQuery / Bootstrap (Phase 6+) >> no data-toggle="tab" attributes remain
- Location: tests/e2e/10-no-jquery-bootstrap.spec.js:113:3
