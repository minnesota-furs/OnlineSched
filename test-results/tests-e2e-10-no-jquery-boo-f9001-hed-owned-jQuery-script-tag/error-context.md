...
- Name: tests/e2e/10-no-jquery-bootstrap.spec.js >> 10 — No jQuery / Bootstrap (Phase 6+) >> no OnlineSched-owned jQuery script tag
- Location: tests/e2e/10-no-jquery-bootstrap.spec.js:27:3
