...
- Name: tests/e2e/10-no-jquery-bootstrap.spec.js >> 10 — No jQuery / Bootstrap (Phase 6+) >> no data-dismiss="modal" attributes remain
- Location: tests/e2e/10-no-jquery-bootstrap.spec.js:120:3
