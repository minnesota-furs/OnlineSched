...
- Name: tests/e2e/10-no-jquery-bootstrap.spec.js >> 10 — No jQuery / Bootstrap (Phase 6+) >> no Bootstrap col-lg- classes remain in OnlineSched DOM
- Location: tests/e2e/10-no-jquery-bootstrap.spec.js:98:3
