...
// Kiosk targets Edge at the convention floor display size. Set
// PLAYWRIGHT_NO_EDGE=1 to fall back to Chromium where Edge is absent.
...
module.exports = defineConfig({
  ...
  retries: 2,       // retry up to 2x to handle transient Docker page-load timeouts under parallel load
